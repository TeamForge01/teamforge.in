...
import { collection, query, where, onSnapshot, orderBy, limit, getDoc, doc, getDocs, updateDoc } from 'firebase/firestore';
      ...
      <main className="flex-1 ml-64 p-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <aside className="space-y-8">
            ...
            {/* AI Aura Chip Feature */}
            <section className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-[#1f1b12] flex items-center gap-2">
              ...
              <div className="space-y-4">
                {suggestedMatches.map((match) => (
                  <motion.div
                    key={match.id}
                    whileHover={{ x: 5 }}
                    className="bg-white p-5 rounded-2xl border border-[#111111]/5 shadow-sm group cursor-pointer"
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-bold text-sm text-[#1f1b12] truncate">{match.displayName}</p>
                    ...
                    <p className="text-[11px] text-[#564338] font-medium leading-relaxed italic opacity-80">
                      "{match.matchReason}"
                    </p>
                ...
                {suggestedMatches.length === 0 && !isMatching && (
                  <div className="p-6 bg-white/50 rounded-2xl border border-dashed border-[#903f00]/10 text-center">
                    <p className="text-xs text-[#564338] italic font-bold">No matches found yet. Forge your profile more!</p>
                  </div>
                )}
              </div>
            </section>
